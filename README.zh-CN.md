...
| 3. 技术设计 | 技术方案与任务拆分 | 私有技术设计 + 任务清单 |
| 4. 开发与质量 | 开发实现 + 测试 + 安全审计 | 代码 + 私有审计记录 |
| 5. 发布与部署 | 整理可分发产物（符合 GitHub 规范）+ 部署上线 | README / 版本 / Release；运行记录私有保存 |
| 6. 宣传与冷启动 | 首发包（视频脚本/文章/渠道） | 私有宣传材料，不随项目发布 |
| 7. 运营与增长 | 数据看板、反馈渠道、增长动作 | 私有运营记录 |
| 8. 迭代与维护 | 反馈池、路线图，完成后循环进入下一轮 | 私有迭代记录 |
