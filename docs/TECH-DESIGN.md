...
3. **persona 尾部追加"阶段门禁总则"**：12 环节归纳为 6 阶段技能映射表；每个 SKILL.md 定义本阶段的追问清单/产出物模板/验收标准
...
| T11 | 自举试跑：新对话用本模式开发一个小东西 | 6 阶段走通、门禁生效 |
