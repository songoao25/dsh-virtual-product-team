...
- MVP 思维：MVP 不是阉割版，是**验证最关键假设的最小实验**。
...
## 目标
产出 `.product-team/idea-validation.md`：问题-方案假设、目标用户画像、证据调研（竞品/社区/可行性）、MVP 范围初判、**值得做/不值得做/要调整**的结论。该文件是私有工作资料，不得发布。
...
5. **写文档**（`.product-team/idea-validation.md`），模板：
